// server/sockets/legacySocketHandlers.js

// IMPORTANT: This 'connectedUsers' Set and 'MAX_USERS' will NOT work correctly
// for scalable multi-server deployments. Each server instance will have its own
// independent set, leading to incorrect user counts and peer discovery.
// For scalability, use a Socket.IO adapter (e.g., Redis) and Socket.IO rooms.
const connectedUsers = new Set();
const MAX_USERS = 2; // Define the maximum number of users allowed for active peering

/**
 * Initializes the legacy Socket.IO event handlers.
