  ...
  const handleLoginSubmit = async (data) => {
    ...
    try {
      ...
      if (data.email === 'test@example.com' && data.password === 'password123') {
        ...
        // In a real app, you'd redirect here, e.g., navigate('/podcast');
      } else {
      ...
      <div className="bg-[#1F1F1F] rounded-lg shadow-xl w-full max-w-4xl flex overflow-hidden">
        ...
        <div className="relative flex-1 bg-gradient-to-br from-[#8A65FD] to-[#724EE0] p-8 hidden md:flex items-center justify-center flex-col text-center">
          <div className="absolute inset-0 bg-cover bg-center opacity-20"
               style={{ backgroundImage: `url('/path/to/your/abstract-background-image.jpg')` || `url('https://source.unsplash.com/random/800x600/?abstract,sound')` }}>
        ...
        <div className="w-full md:w-1/2 p-8 lg:p-12">
          ...
          {errors.credentials && <p className="text-red-500 text-sm text-center mb-4">{errors.credentials.message}</p>}
